...
// Simplified getLocalIP for iSH - just return a placeholder
function getLocalIP() {
  // iSH doesn't support os.networkInterfaces() properly
  // User will need to find their IP manually
  return 'YOUR-IPHONE-IP';
}
...
server.listen(PORT, () => {
  ...
  console.log('🎮 KAHOOT-STYLE QUIZ SERVER (iSH Compatible)');
  console.log('='.repeat(50));
  console.log(`✅ Server running on port ${PORT}`);
  console.log(`📝 Questions loaded: ${gameState.questions.length}`);
  console.log('='.repeat(50));
  console.log('📱 IMPORTANT: Find your iPhone IP manually:');
  console.log('   Settings → WiFi → (i) → IP Address');
  console.log('');
  console.log('   Students connect to: http://YOUR-IP:8080');
  console.log('   Host opens: http://localhost:8080/host.html');
  console.log('='.repeat(50));
